...
namespace CSHomeworkAPI.Migrations
{
    ...
    [Migration("20171119151504_CSHomeworkDBIAddingQuestionToTypeJoin")]
    partial class CSHomeworkDBIAddingQuestionToTypeJoin
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CSHomeworkAPI.Entities.Question", b =>
                {
                    b.HasOne("CSHomeworkAPI.Entities.Type", "Type")
                        .WithOne("Question")
                        .HasForeignKey("CSHomeworkAPI.Entities.Question", "Id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
